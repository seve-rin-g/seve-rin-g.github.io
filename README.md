...
A small (1-page) project I solo-developed in d3/js, showing bar/scatter plots. Researcher-maintained datasource with lots of low-complexity data.
...
Right (stacked bar plot): this gives the user an idea of the min, max, and average ranges of this trace element (in this case, Mn) that they can expect in this process. 
